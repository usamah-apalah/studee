...
export default function Login() {
  ...
  return (
    <main className="min-h-screen app-theme-bg font-sans flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <Link
        href="/"
        className="absolute top-6 left-6 flex items-center gap-2 app-theme-text-muted app-theme-card hover:bg-black/5 dark:hover:bg-white/5 rounded-xl py-2 px-4 transition-all text-sm"
      >
      ...
      <div className="max-w-md w-full app-theme-card rounded-3xl p-8 md:p-10 shadow-2xl relative overflow-hidden">
        ...
        <div className="text-center mb-8 relative z-10">
          <h1 className="text-3xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-purple-600 via-indigo-600 to-blue-600 dark:from-white dark:to-indigo-200">
            Welcome Back
          </h1>
        ...
        <form onSubmit={handleLogin} className="space-y-4 relative z-10">
          <div>
            ...
            <input
              ...
              className="w-full bg-[var(--card-bg)] border border-[var(--border-color)] rounded-2xl py-3.5 px-4 text-[var(--text-color)] placeholder-[var(--text-color)]/30 focus:outline-none focus:ring-2 focus:ring-purple-400 transition-all text-sm font-semibold"
            />
          </div>

          <button
            type="submit"
            className="w-full bg-gradient-to-r from-purple-500 to-indigo-500 hover:from-purple-600 hover:to-indigo-600 text-white rounded-2xl py-3.5 px-4 font-semibold transition-all flex items-center justify-center gap-2 cursor-pointer shadow-lg active:scale-[0.98] border border-white/10"
          >
            Lanjutkan
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="space-y-3 relative z-10 flex flex-col items-center w-full">
          <button
            ...
            className="w-full app-theme-card hover:bg-black/5 dark:hover:bg-white/5 text-[var(--text-color)] rounded-2xl py-3.5 px-4 font-semibold transition-all flex items-center justify-center gap-3 cursor-pointer shadow-lg active:scale-[0.98] hover:shadow-purple-500/10"
          >
